...
* @returns
*/
function openSystemMsgtempletWin(config, callBack)
{

    var url = config.url || $AppContext + '/system/msgtemplet/list';
    ...
    var options = config || {};
    options.id = "_SystemMsgtempletListPanel" + config.callId;
    options.width = 616;
    options.height = 550;
    ...
    {field:"id", checkbox: true, width: 40},
        {field:"msgTempletName", title:"消息模板名称", width: 150, align:"left" ,},
        {field:"msgTempletTypeName", title:"消息模板类型", width: 150, align:"left" ,},
        {field:"msgTitle", title:"消息标题", width: 150, align:"left" ,},
        {field:"msgLanguageName", title:"语言", width: 150, align:"left" ,},
        {field:"templetEffectiveName", title:"模板是否有效", width: 150, align:"left" ,},
...
//消息模板选择控件
$.fn.OpenSystemMsgtempletSelectWin = function(config, callBack){
    var win = openSystemMsgtempletWin(config, callBack);
    $(this).unbind("click");
