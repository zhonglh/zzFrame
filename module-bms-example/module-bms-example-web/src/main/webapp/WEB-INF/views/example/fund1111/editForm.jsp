                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                        <div class="info-detail">
                                            <textarea  class="form-control input-sm  "
                                              name="incomeAllocation" placeholder="请输入收入分配，500字以内" maxlength="500" rows="6">${ m.incomeAllocation }</textarea>
                                        </div>
                                </td>
                            </tr>
                        ...
                        <div class="fundAccount">
                            <table id='tableData-fundAccount' class='easyui-datagrid' singleSelect="true" scrollbarSize="0"   method='post' fit='false'  fitColumns="true" border='true'>
                                ...
                                <tr>
                                    ...
                                    <th field="option" align="left" hidden="true"   formatter="markFmt">操作</th>
                                </tr>
                                </thead>
                            </table>
