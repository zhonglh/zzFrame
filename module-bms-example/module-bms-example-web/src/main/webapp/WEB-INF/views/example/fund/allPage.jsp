...
<script type="text/javascript">
    ...
    var urls = [
            ctx+'/fundmanage/fund/${ m.id }/update?inAllPage=1',
            ctx+'/fundmanage/outmoney/toList?inAllPage=1&fundId=${ m.id }',
            ctx+'/fundmanage/investoragreement/toList?inAllPage=1&fundId=${ m.id }'
    ];
