...
<script type="text/javascript">
    ...
    var urls = [
            ctx+'/fundmanage/investor/${ m.id }/update?inAllPage=1',
            ctx+'/fundmanage/outmoney/toList?inAllPage=1&investorId=${ m.id }',
            ctx+'/fundmanage/investoragreement/toList?inAllPage=1&investorId=${ m.id }'
    ];
